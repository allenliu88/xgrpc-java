...
public class NetUtils {
    ...
    @Deprecated
    private static final String CLIENT_NAMING_LOCAL_IP_PROPERTY = "io.xgrpc.client.naming.local.ip";

    private static final String CLIENT_LOCAL_IP_PROPERTY = "io.xgrpc.client.local.ip";

    private static final String CLIENT_LOCAL_PREFER_HOSTNAME_PROPERTY = "io.xgrpc.client.local.preferHostname";
