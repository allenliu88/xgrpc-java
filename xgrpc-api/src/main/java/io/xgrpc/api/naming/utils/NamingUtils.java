...
package io.xgrpc.api.naming.utils;

import static io.xgrpc.api.common.Constants.CLUSTER_NAME_PATTERN_STRING;
import static io.xgrpc.api.common.Constants.NUMBER_PATTERN_STRING;
...
import io.xgrpc.api.naming.pojo.Instance;
import io.xgrpc.api.utils.StringUtils;
...
public class NamingUtils {
     ...
     * @throws XgrpcException if check failed, throw exception
     */
    public static void checkInstanceIsLegal(Instance instance) throws XgrpcException {
        if (instance.getInstanceHeartBeatTimeOut() < instance.getInstanceHeartBeatInterval()
                || instance.getIpDeleteTimeout() < instance.getInstanceHeartBeatInterval()) {
            throw new XgrpcException(XgrpcException.INVALID_PARAM,
     ...
     */
    public static void checkInstanceIsEphemeral(Instance instance) throws XgrpcException {
     ...
     * @throws XgrpcException Nacos
     */
    public static void batchCheckInstanceIsLegal(List<Instance> instances) throws XgrpcException {
