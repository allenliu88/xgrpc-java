...
package io.xgrpc.api.naming.pojo.healthcheck;

import java.io.Serializable;

import io.xgrpc.api.naming.pojo.healthcheck.impl.Http;
import io.xgrpc.api.naming.pojo.healthcheck.impl.Mysql;
import io.xgrpc.api.naming.pojo.healthcheck.impl.Tcp;
 ...
 * @author nkorange
 */
@JsonTypeInfo(use = Id.NAME, property = "type", defaultImpl = AbstractHealthChecker.None.class)
@JsonSubTypes({@JsonSubTypes.Type(name = Http.TYPE, value = Http.class),
        ...
        @JsonSubTypes.Type(name = AbstractHealthChecker.None.TYPE, value = AbstractHealthChecker.None.class)})
