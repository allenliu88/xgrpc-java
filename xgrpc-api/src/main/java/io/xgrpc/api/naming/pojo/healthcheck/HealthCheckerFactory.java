...
import io.xgrpc.api.naming.pojo.healthcheck.AbstractHealthChecker.None;
...
public class HealthCheckerFactory {
    ...
    public static AbstractHealthChecker deserialize(String jsonString) {
        try {
            ...
            throw new XgrpcDeserializationException(AbstractHealthChecker.class, e);
        }
    }
    ...
    public static String serialize(AbstractHealthChecker healthChecker) {
        try {
            ...
            throw new XgrpcSerializationException(healthChecker.getClass(), e);
        }
    }
}
