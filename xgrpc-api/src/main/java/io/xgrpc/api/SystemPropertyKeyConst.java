...
public interface SystemPropertyKeyConst {
     ...
     * </p>
     */
    String IS_USE_CLOUD_NAMESPACE_PARSING = "xgrpc.use.cloud.namespace.parsing";
     ...
     */
    String IS_USE_ENDPOINT_PARSING_RULE = "xgrpc.use.endpoint.parsing.rule";
}
