...
import io.xgrpc.core.remote.listener.ClientConnectionEventListener;
...
public class ClientConnectionEventListenerRegistry {
    final List<ClientConnectionEventListener> clientConnectionEventListeners = ServiceLoaderUtils.load(ClientConnectionEventListener.class);
