...
public abstract class RequestHandler<T extends Request, S extends Response> {
    private RequestFilters requestFilters = RequestFilters.getInstance();
     ...
     * @return response
     * @throws XgrpcException xgrpc exception when handle request has problem.
     */
