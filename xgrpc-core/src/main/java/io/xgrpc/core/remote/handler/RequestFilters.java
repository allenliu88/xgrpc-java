...
public class RequestFilters {
    private static RequestFilters INSTANCE = new RequestFilters();
    private RequestFilters() {}

    public static RequestFilters getInstance() {
        return INSTANCE;
    }
    
    List<AbstractRequestFilter> filters = ServiceLoaderUtils.load(AbstractRequestFilter.class);
