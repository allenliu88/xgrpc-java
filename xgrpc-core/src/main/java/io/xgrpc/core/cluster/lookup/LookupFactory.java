...
import io.xgrpc.core.cluster.MemberLookup;
...
public final class LookupFactory {
     ...
     */
    public static MemberLookup createLookUp(ServerMemberManager memberManager) throws XgrpcException {
     ...
     * @param memberManager {@link ServerMemberManager}
     * @return {@link MemberLookup}
     * @throws XgrpcException {@link XgrpcException}
     */
    public static MemberLookup switchLookup(String name, ServerMemberManager memberManager) throws XgrpcException {
    ...
    public static void destroy() throws XgrpcException {
