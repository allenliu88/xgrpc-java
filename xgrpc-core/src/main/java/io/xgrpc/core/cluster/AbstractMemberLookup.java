...
public abstract class AbstractMemberLookup implements MemberLookup {
    ...
    @Override
    public void destroy() throws XgrpcException {
    ...
    @Override
    public void start() throws XgrpcException {
     ...
     */
    protected abstract void doStart() throws XgrpcException;
    
    /**
     * subclass can override this method if need.
     * @throws XgrpcException XgrpcException
     */
    protected abstract void doDestroy() throws XgrpcException;
}
