...
import io.xgrpc.common.executor.ExecutorFactory;
import io.xgrpc.common.executor.NameThreadFactory;
...
public class WatchFileCenter {
     ...
     */
    public static synchronized boolean registerWatcher(final String paths, FileWatcher watcher) throws XgrpcException {
        checkState();
    ...
    private static class WatchDirJob extends Thread {
        ...
        public WatchDirJob(String paths) throws XgrpcException {
            setName(paths);
            this.paths = paths;
            ...
            this.callBackExecutor = ExecutorFactory
                    .newSingleExecutorService(new NameThreadFactory("io.xgrpc.sys.file.watch-" + paths));
            ...
            try {
                ...
                throw new XgrpcException(XgrpcException.SERVER_ERROR, ex);
            }
        }
