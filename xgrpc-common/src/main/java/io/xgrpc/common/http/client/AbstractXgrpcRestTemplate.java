...
import io.xgrpc.common.constant.ResponseHandlerType;
import io.xgrpc.common.http.client.handler.BeanResponseHandler;
import io.xgrpc.common.http.client.handler.ResponseHandler;
import io.xgrpc.common.http.client.handler.RestResultResponseHandler;
import io.xgrpc.common.http.client.handler.StringResponseHandler;
import io.xgrpc.common.utils.JacksonUtils;
import org.slf4j.Logger;

/**
 * For XgrpcRestTemplate and XgrpcAsyncRestTemplate, provide initialization and register of response converter.
 *
 * @author mai.jh
 */
@SuppressWarnings("all")
public abstract class AbstractXgrpcRestTemplate {
    
    private final Map<String, ResponseHandler> responseHandlerMap = new HashMap<String, ResponseHandler>();
    
    protected final Logger logger;
    
    public AbstractXgrpcRestTemplate(Logger logger) {
        this.logger = logger;
