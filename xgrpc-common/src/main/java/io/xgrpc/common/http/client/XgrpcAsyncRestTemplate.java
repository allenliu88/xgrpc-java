...
import io.xgrpc.common.http.client.request.AsyncHttpClientRequest;
...
import io.xgrpc.common.utils.HttpMethod;
import org.slf4j.Logger;

/**
 * Xgrpc async rest template.
 *
 * @author mai.jh
 * @see AsyncHttpClientRequest
 * @see HttpClientResponse
 */
public class XgrpcAsyncRestTemplate extends AbstractXgrpcRestTemplate {
    
    private final AsyncHttpClientRequest clientRequest;
    
    public XgrpcAsyncRestTemplate(Logger logger, AsyncHttpClientRequest clientRequest) {
        super(logger);
     ...
     * @param callback     callback {@link Callback#onReceive(io.xgrpc.common.model.RestResult)}
     */
