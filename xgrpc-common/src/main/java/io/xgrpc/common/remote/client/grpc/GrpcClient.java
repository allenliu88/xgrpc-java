...
import io.xgrpc.common.remote.client.RpcClientStatus;
...
public abstract class GrpcClient extends RpcClient {
    ...
    protected static final String XGRPC_SERVER_GRPC_PORT_OFFSET_KEY = "xgrpc.server.grpc.port.offset";
    ...
    protected ThreadPoolExecutor createGrpcExecutor(String serverIp) {
        ThreadPoolExecutor grpcExecutor = new ThreadPoolExecutor(
                ...
                new ThreadFactoryBuilder()
                        .daemon(true)
                        .nameFormat("xgrpc-grpc-client-executor-" + serverIp + "-%d")
                        .build());
    ...
    private int getInboundMessageSize() {
        String messageSize = System.getProperty("xgrpc.remote.client.grpc.maxinbound.message.size",
    ...
    private int keepAliveTimeMillis() {
        String keepAliveTimeMillis = System
                .getProperty("xgrpc.remote.grpc.keep.alive.millis", String.valueOf(DEFAULT_KEEP_ALIVE_TIME));
                    ...
                    if (request != null) {
                        ...
                        try {
                            ...
                            Response errResponse = ErrorResponse
                                    .build(XgrpcException.CLIENT_ERROR, "Handle server request error");
