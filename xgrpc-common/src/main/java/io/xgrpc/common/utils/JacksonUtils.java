...
public final class JacksonUtils {
     ...
     * @param obj obj
     * @return json string
     * @throws XgrpcSerializationException if transfer failed
     */
    public static String toJson(Object obj) {
        try {
            return mapper.writeValueAsString(obj);
        } catch (JsonProcessingException e) {
            throw new XgrpcSerializationException(obj.getClass(), e);
        }
    }
     ...
     * @return object
     * @throws XgrpcDeserializationException if deserialize failed
     */
    public static <T> T toObj(byte[] json, Class<T> cls) {
        try {
            return mapper.readValue(json, cls);
        } catch (Exception e) {
            throw new XgrpcDeserializationException(cls, e);
        }
    }
    ...
    public static <T> T toObj(byte[] json, Type cls) {
        try {
            ...
            throw new XgrpcDeserializationException(e);
        }
    }
    ...
    public static <T> T toObj(String json, TypeReference<T> typeReference) {
        try {
            ...
            throw new XgrpcDeserializationException(typeReference.getClass(), e);
        }
    }
    ...
    public static <T> T toObj(InputStream inputStream, Type type) {
        try {
            ...
            throw new XgrpcDeserializationException(type, e);
        }
    }
